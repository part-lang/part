...
PHP_METHOD(Part_Page_Main, notfound) {
	...
	if (!((zephir_file_exists(location TSRMLS_CC) == SUCCESS))) {
		...
		ZVAL_LONG(&_5$$3, 404);
		ZEPHIR_CALL_METHOD(&_4$$3, &main$$3, "config", NULL, 23, &_0$$3, &_5$$3);
		zephir_check_call_status();
		if (ZEPHIR_IS_STRING(&_4$$3, "none")) {
			ZEPHIR_INIT_VAR(&_6$$4);
			ZVAL_STRING(&_6$$4, "/etc/part/page/404.html");
			ZEPHIR_CALL_FUNCTION(&_7$$4, "file_get_contents", &_8, 14, &_6$$4, &__$true);
			zephir_check_call_status();
			...
			ZVAL_LONG(&_11$$5, 404);
			ZEPHIR_CALL_METHOD(&_9$$5, &main$$3, "config", NULL, 23, &_10$$5, &_11$$5);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&_12$$5, "file_get_contents", &_8, 14, &_9$$5, &__$true);
			zephir_check_call_status();
...
PHP_METHOD(Part_Page_Main, forbidden) {
	...
	ZVAL_LONG(&_5, 403);
	ZEPHIR_CALL_METHOD(&_4, &main, "config", NULL, 23, &_0, &_5);
	zephir_check_call_status();
	if (ZEPHIR_IS_STRING(&_4, "none")) {
		ZEPHIR_INIT_VAR(&_6$$3);
		ZVAL_STRING(&_6$$3, "/etc/part/page/403.html");
		ZEPHIR_CALL_FUNCTION(&_7$$3, "file_get_contents", &_8, 14, &_6$$3, &__$true);
		zephir_check_call_status();
		...
		ZVAL_LONG(&_11$$4, 403);
		ZEPHIR_CALL_METHOD(&_9$$4, &main, "config", NULL, 23, &_10$$4, &_11$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_12$$4, "file_get_contents", &_8, 14, &_9$$4, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Part_Page_Main, content) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&plang, "file_get_contents", NULL, 14, location, &__$true);
	zephir_check_call_status();
...
PHP_METHOD(Part_Page_Main, config) {
	...
	if ((zephir_file_exists(&location TSRMLS_CC) == SUCCESS)) {
		ZEPHIR_CALL_FUNCTION(&setting, "parse_ini_file", NULL, 24, &location, &__$true);
		zephir_check_call_status();
