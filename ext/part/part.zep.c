...
PHP_METHOD(Part_Part, main_engine) {
	...
	if (ZEPHIR_IS_STRING(&location, "")) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, &main, "config", NULL, 38, &_3$$3, &_4$$3);
		zephir_check_call_status();
		if (ZEPHIR_IS_STRING(&_2$$3, "none")) {
			...
			ZEPHIR_CALL_METHOD(&location, &main, "config", NULL, 38, &_5$$5, &_6$$5);
			zephir_check_call_status();
		}
	}
	ZVAL_LONG(&_7, 4);
	ZEPHIR_CALL_FUNCTION(&extension, "pathinfo", NULL, 19, &location, &_7);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &main, "notfound", NULL, 40, &location);
	zephir_check_call_status();
	do {
		if (ZEPHIR_IS_STRING(&extension, "p")) {
			...
			if (!((zephir_file_exists(&_8$$6 TSRMLS_CC) == SUCCESS))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &main, "content", NULL, 41, &_9$$8, &_10$$8);
				zephir_check_call_status();
			}
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "pp")) {
			ZEPHIR_CALL_METHOD(NULL, &main, "forbidden", NULL, 42);
			zephir_check_call_status();
			break;
		}
		...
		if (ZEPHIR_IS_STRING(&extension, "html")) {
			...
			ZEPHIR_CALL_METHOD(NULL, &main, "content", NULL, 41, &location, &_11$$11);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "css")) {
			...
			ZEPHIR_CALL_METHOD(NULL, &main, "content", NULL, 41, &location, &_12$$12);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "js")) {
			...
			ZEPHIR_CALL_METHOD(NULL, &main, "content", NULL, 41, &location, &_13$$13);
			zephir_check_call_status();
			break;
		}
		ZEPHIR_INIT_VAR(&_14$$14);
		ZVAL_STRING(&_14$$14, "text/plain");
		ZEPHIR_CALL_METHOD(NULL, &main, "content", NULL, 41, &location, &_14$$14);
		zephir_check_call_status();
	} while(0);
...
PHP_METHOD(Part_Part, engine) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &library, "loader", NULL, 43, &plang);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&plang, &_0);
	ZEPHIR_CALL_METHOD(&_0, &text, "loader", NULL, 44, &plang);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&plang, &_0);
	ZEPHIR_CALL_METHOD(&_0, &functions, "loader", NULL, 45, &plang);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&plang, &_0);
	ZEPHIR_CALL_METHOD(&_0, &statement, "loader", NULL, 46, &plang);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&plang, &_0);
	ZEPHIR_INIT_VAR(&_1);
	zephir_eval_php(&plang, &_1, "/home/devilscream/part/part/part.zep:67" TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
