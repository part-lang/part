...
ZEPHIR_INIT_FUNCS(part_statement_main_method_entry) {
	PHP_ME(Part_Statement_Main, switch_statement, arginfo_part_statement_main_switch_statement, ZEND_ACC_PUBLIC)
	PHP_ME(Part_Statement_Main, while_statement, arginfo_part_statement_main_while_statement, ZEND_ACC_PUBLIC)
	PHP_ME(Part_Statement_Main, if_statement, arginfo_part_statement_main_if_statement, ZEND_ACC_PUBLIC)
	PHP_ME(Part_Statement_Main, for_statement, arginfo_part_statement_main_for_statement, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
