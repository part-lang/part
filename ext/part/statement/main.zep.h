...
ZEND_BEGIN_ARG_INFO_EX(arginfo_part_statement_main_loader, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(part_statement_main_method_entry) {
	PHP_ME(Part_Statement_Main, loader, arginfo_part_statement_main_loader, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC)
