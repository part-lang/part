...
ZEPHIR_INIT_FUNCS(part_text_main_method_entry) {
	PHP_ME(Part_Text_Main, symbol, arginfo_part_text_main_symbol, ZEND_ACC_PUBLIC)
	PHP_ME(Part_Text_Main, write, arginfo_part_text_main_write, ZEND_ACC_PUBLIC)
	PHP_ME(Part_Text_Main, variable, arginfo_part_text_main_variable, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
