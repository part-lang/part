...
PHP_METHOD(Plang_Main_Plang, main_engine) {
	...
	zephir_fcall_cache_entry *_1 = NULL, *_6 = NULL, *_18 = NULL;
	zval *location = NULL, *plang = NULL, _4, *_5 = NULL, _0$$4 = zval_used_for_init, *_2$$4 = NULL, *_3$$4, *_7$$5 = NULL, _8$$5, _9$$5, _10$$5, _11$$5, _12$$5, _13$$5, _14$$5, _15$$5, *_16$$5 = NULL, *_17$$5 = NULL;
	...
	if (ZEPHIR_IS_STRING(_5, "p")) {
		...
		ZVAL_STRING(_16$$5, "$_GET[$1];", ZEPHIR_TEMP_PARAM_COPY);
		...
		ZVAL_STRING(_16$$5, "$_REQUEST[$1];", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "$_POST[$1];", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "exec($1);", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "include('$1');", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "$$1 = $2;", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZVAL_STRING(_7$$5, "/var (.*)/", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "$$1", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(plang, _17$$5);
		ZEPHIR_INIT_NVAR(_7$$5);
		ZVAL_STRING(_7$$5, "/plus (.*)/", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "$$1 ++", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "strlen($$1)", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "htmlspecialchars($$1)", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, ";echo $1;", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, ";return $1;", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "if($1){", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "} else if($1){", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "for($1){", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "foreach($1){", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "}else{", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "}", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "class $1 {", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "public $$1 = $2", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_16$$5);
		ZVAL_STRING(_16$$5, "$this->$1;", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_FUNCTION(&_17$$5, "preg_replace", &_18, 5, _7$$5, _16$$5, plang);
		zephir_check_temp_parameter(_7$$5);
		zephir_check_temp_parameter(_16$$5);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(plang, _17$$5);
		ZEPHIR_INIT_NVAR(_7$$5);
		zephir_eval_php(plang, _7$$5, "/home/ubuntu/workspace/plang/plang/main/plang.zep:54" TSRMLS_CC);
	} else {
		ZEPHIR_CALL_FUNCTION(&plang, "file_get_contents", &_6, 4, location, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
