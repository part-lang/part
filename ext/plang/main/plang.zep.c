...
PHP_METHOD(Plang_Main_Plang, engine) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *location, *plang = NULL, *main = NULL, *_0 = NULL, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, *_15 = NULL, *_16 = NULL;
	...
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(plang, _16);
	ZEPHIR_CALL_METHOD(&_16, main, "http", NULL, 7, plang);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(plang, _16);
	ZEPHIR_CALL_METHOD(&_16, main, "variable", NULL, 8, plang);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(plang, _16);
	ZEPHIR_CALL_METHOD(&_16, main, "print", NULL, 9, plang);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(plang, _16);
	ZEPHIR_INIT_NVAR(_0);
	...
	ZEPHIR_CPY_WRT(plang, _16);
	ZEPHIR_INIT_NVAR(_0);
	zephir_eval_php(plang, _0, "/home/ubuntu/workspace/plang/plang/main/plang.zep:58" TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Plang_Main_Plang, content) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "header", NULL, 10, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&plang, "file_get_contents", NULL, 5, location, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
...
PHP_METHOD(Plang_Main_Plang, notfound) {
	...
	if (!((zephir_file_exists(location TSRMLS_CC) == SUCCESS))) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "header", &_1, 10, &_0$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0$$3);
		ZVAL_STRING(&_0$$3, "D, d M Y h:i:s T", 0);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "date", NULL, 11, &_0$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_3$$3);
		ZEPHIR_CONCAT_SV(_3$$3, "Date: ", _2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "header", &_1, 10, _3$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0$$3);
...
PHP_METHOD(Plang_Main_Plang, print) {
	...
	ZEPHIR_INIT_VAR(_1);
	ZVAL_STRING(_1, "strlen($$1)", ZEPHIR_TEMP_PARAM_COPY);
	...
	ZEPHIR_INIT_NVAR(_1);
	ZVAL_STRING(_1, "htmlspecialchars($$1)", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_FUNCTION(&_2, "preg_replace", &_3, 6, _0, _1, plang);
	zephir_check_temp_parameter(_0);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
