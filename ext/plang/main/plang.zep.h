...
ZEND_BEGIN_ARG_INFO_EX(arginfo_plang_main_plang_http, 0, 0, 1)
	ZEND_ARG_INFO(0, plang)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_plang_main_plang_variable, 0, 0, 1)
	ZEND_ARG_INFO(0, plang)
ZEND_END_ARG_INFO()

ZEPHIR_INIT_FUNCS(plang_main_plang_method_entry) {
	PHP_ME(Plang_Main_Plang, main_engine, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
